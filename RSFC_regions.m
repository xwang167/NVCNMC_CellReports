...
% M SS P V RS A
%left
mask_region_ind{1} = [3,4];
mask_region_ind{2} = 6:13;
mask_region_ind{3} = [14,19,20];
mask_region_ind{4} = 15:18;
mask_region_ind{5} = 21:23;
mask_region_ind{6} = [24,25];

% right
mask_region_ind{7} = [28,29];
mask_region_ind{8} = 31:38;
mask_region_ind{9} = [39,44,45];
mask_region_ind{10} = 40:43;
mask_region_ind{11} = 46:48;
mask_region_ind{12} = [49,50];
