...
HbT =  filterData(HbT,0.01,5,samplingRate);
Calcium = filterData(Calcium,0.01,5,samplingRate);
...
sgtitle('HRF for Each Pixel, 0.01-5Hz, Awake R5M2285 for Second Block for Run 1')
...
sgtitle('HRF for Barrel Region, 0.01-5Hz, Awake R5M2285 for Second Block for Run 1')
