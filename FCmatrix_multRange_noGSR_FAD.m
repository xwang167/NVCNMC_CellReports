...
%         FCMatrix_FAD_ISA_old = calcFCMatrix_noGSR(squeeze(xform_FADCorr),0.009,0.08,fs,xform_isbrain_mice);
%         FCMatrix_FAD_Delta_old = calcFCMatrix_noGSR(squeeze(xform_FADCorr),0.4,4,fs,xform_isbrain_mice);
%         FCMatrix_FAD_0p02 = calcFCMatrix_noGSR(squeeze(xform_FADCorr),0.02,0.08,fs,xform_isbrain_mice);
%         FCMatrix_FAD_0p04 = calcFCMatrix_noGSR(squeeze(xform_FADCorr),0.04,0.16,fs,xform_isbrain_mice);
%         FCMatrix_FAD_0p08 = calcFCMatrix_noGSR(squeeze(xform_FADCorr),0.08,0.32,fs,xform_isbrain_mice);
%         FCMatrix_FAD_0p16 = calcFCMatrix_noGSR(squeeze(xform_FADCorr),0.16,0.64,fs,xform_isbrain_mice);
%         FCMatrix_FAD_0p32 = calcFCMatrix_noGSR(squeeze(xform_FADCorr),0.32,1.28,fs,xform_isbrain_mice);
%         FCMatrix_FAD_0p64 = calcFCMatrix_noGSR(squeeze(xform_FADCorr),0.64,2.56,fs,xform_isbrain_mice);
%         FCMatrix_FAD_1p28 = calcFCMatrix_noGSR(squeeze(xform_FADCorr),1.28,5.12,fs,xform_isbrain_mice);
%         clear xform_FADCorr
