...
for excelRow = [181 183 185 228 232 236]% 
    ...
    if exist(fullfile(maskDir,strcat(recDate,'-',mouseName,'-',sessionType,num2str(1),'-dataFluor.mat')),'file')
        ...
        close all
        save(fullfile(saveDir,'Barrel_HRF', strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'_Barrel_HRF','.mat')),'r_GSR_Barrel_HRF','HRF_GSR_Barrel','-append')
    end
end
...
[pks,locs,w,p] = findpeaks(HRF_GSR_Barrel_0p6_median,t,'MinPeakProminence',0.02);
