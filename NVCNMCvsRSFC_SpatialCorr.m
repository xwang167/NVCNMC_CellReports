...
corr_Calcium_ISA = nan(1,44); 
corr_FAD_ISA     = nan(1,44); 
corr_HbT_ISA     = nan(1,44); 
jj = 1;
for ii = [3,4,6:25,28,29,31:50]
    ...
    corr_Calcium_ISA(jj) = corr(awake_Calcium',anes_Calcium','rows','complete');
    ...
    corr_FAD_ISA(jj) = corr(awake_FAD',anes_FAD','rows','complete');
    ...
    corr_HbT_ISA(jj) = corr(awake_HbT',anes_HbT','rows','complete');
    end
    jj = jj+1;
    close all
end
...
% for ii = 1:44
%     if ~isnan(corr_Calcium_ISA(ii))
%     scatter(corr_Calcium_ISA(ii),T_HRF_mice_anes_exclude_mean(ii)-T_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",[0,0,0],"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% 
% mdl_HRF_T_Calcium = fitlm(corr_Calcium_ISA,T_HRF_mice_anes_exclude_mean-T_HRF_mice_awake_exclude_mean);
% hold on
...
% 
% title('HRF T vs. Calcium Spatial Corr')
% xlabel('Calcium Spatial Corr')
% ylabel('HRF T')
% 
% handle = subplot(3,2,2);
% for ii = 1:44
%     if ~isnan(corr_HbT_ISA(ii))
%     scatter(corr_HbT_ISA(ii),T_HRF_mice_anes_exclude_mean(ii)-T_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",[0,0,0],"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% mdl_HRF_T_HbT = fitlm(corr_HbT_ISA,T_HRF_mice_anes_exclude_mean-T_HRF_mice_awake_exclude_mean);
% hold on
...
% annotation('textbox', [p(1), p(2), p(3), p(4)], 'String', equation, 'EdgeColor', 'none', 'Color', 'k');
% 
% title('HRF T vs. HbT Spatial Corr')
% xlabel('HbT Spatial Corr')
% ylabel('HRF T')
% 
% handle = subplot(3,2,3);
% for ii = 1:44
%     if ~isnan(corr_Calcium_ISA(ii))
%     scatter(corr_Calcium_ISA(ii),W_HRF_mice_anes_exclude_mean(ii)-W_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",[0,0,0],"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% mdl_HRF_W_Calcium = fitlm(corr_Calcium_ISA,W_HRF_mice_anes_exclude_mean-W_HRF_mice_awake_exclude_mean);
% hold on
...
% annotation('textbox', [p(1), p(2), p(3), p(4)], 'String', equation, 'EdgeColor', 'none', 'Color', 'k');
% 
% title('HRF W vs. Calcium Spatial Corr')
% xlabel('Calcium Spatial Corr')
% ylabel('HRF W')
% 
% 
...
% for ii = 1:44
%     if ~isnan(corr_HbT_ISA(ii))
%     scatter(corr_HbT_ISA(ii),W_HRF_mice_anes_exclude_mean(ii)-W_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",[0,0,0],"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% mdl_HRF_W_HbT = fitlm(corr_HbT_ISA,W_HRF_mice_anes_exclude_mean-W_HRF_mice_awake_exclude_mean);
% hold on
...
% annotation('textbox', [p(1), p(2), p(3), p(4)], 'String', equation, 'EdgeColor', 'none', 'Color', 'k');
% 
% title('HRF W vs. HbT Spatial Corr')
% xlabel('HbT Spatial Corr')
% ylabel('HRF W')
% 
% 
...
% for ii = 1:44
%     if ~isnan(corr_Calcium_ISA(ii))
%     scatter(corr_Calcium_ISA(ii),A_HRF_mice_anes_exclude_mean(ii)-A_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",[0,0,0],"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% mdl_HRF_A_Calcium = fitlm(corr_Calcium_ISA,A_HRF_mice_anes_exclude_mean-A_HRF_mice_awake_exclude_mean);
% hold on
...
% annotation('textbox', [p(1), p(2), p(3), p(4)], 'String', equation, 'EdgeColor', 'none', 'Color', 'k');
% 
% title('HRF A vs. Calcium Spatial Corr')
% xlabel('Calcium Spatial Corr')
% ylabel('HRF A')
% 
% 
...
% for ii = 1:44
%     if ~isnan(corr_HbT_ISA(ii))
%     scatter(corr_HbT_ISA(ii),A_HRF_mice_anes_exclude_mean(ii)-A_HRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",[0,0,0],"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% mdl_HRF_A_HbT = fitlm(corr_HbT_ISA,A_HRF_mice_anes_exclude_mean-A_HRF_mice_awake_exclude_mean);
% hold on
...
% annotation('textbox', [p(1), p(2), p(3), p(4)], 'String', equation, 'EdgeColor', 'none', 'Color', 'k');
% 
% title('HRF A vs. HbT Spatial Corr')
% xlabel('HbT Spatial Corr')
% ylabel('HRF A')
% %% MRF
% figure('units','normalized','outerposition',[0 0 0.4 1])
...
% for ii = 1:44
%     if ~isnan(corr_Calcium_ISA(ii))
%     scatter(corr_Calcium_ISA(ii),T_MRF_mice_anes_exclude_mean(ii)-T_MRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",[0,0,0],"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% 
% mdl_MRF_T_Calcium = fitlm(corr_Calcium_ISA,T_MRF_mice_anes_exclude_mean-T_MRF_mice_awake_exclude_mean);
% hold on
...
% annotation('textbox', [p(1), p(2), p(3), p(4)], 'String', equation, 'EdgeColor', 'none', 'Color', 'k');
% 
% title('MRF T vs. Calcium Spatial Corr')
% xlabel('Calcium Spatial Corr')
% ylabel('MRF T')
% 
% 
...
% handle = subplot(3,2,2);
% for ii = 1:44
%     if ~isnan(corr_FAD_ISA(ii))
%     scatter(corr_FAD_ISA(ii),T_MRF_mice_anes_exclude_mean(ii)-T_MRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",[0,0,0],"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% mdl_MRF_T_FAD = fitlm(corr_FAD_ISA,T_MRF_mice_anes_exclude_mean-T_MRF_mice_awake_exclude_mean);
% hold on
...
% annotation('textbox', [p(1), p(2), p(3), p(4)], 'String', equation, 'EdgeColor', 'none', 'Color', 'k');
% 
% title('MRF T vs. FAD Spatial Corr')
% xlabel('FAD Spatial Corr')
% ylabel('MRF T')
% 
% 
% handle = subplot(3,2,3);
% for ii = 1:44
%     if ~isnan(corr_Calcium_ISA(ii))
%     scatter(corr_Calcium_ISA(ii),W_MRF_mice_anes_exclude_mean(ii)-W_MRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",[0,0,0],"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% mdl_MRF_W_Calcium = fitlm(corr_Calcium_ISA,W_MRF_mice_anes_exclude_mean-W_MRF_mice_awake_exclude_mean);
% hold on
...
% annotation('textbox', [p(1), p(2), p(3), p(4)], 'String', equation, 'EdgeColor', 'none', 'Color', 'k');
% 
% title('MRF W vs. Calcium Spatial Corr')
% xlabel('Calcium Spatial Corr')
% ylabel('MRF W')
% 
% handle = subplot(3,2,4);
% for ii = 1:44
%     if ~isnan(corr_FAD_ISA(ii))
%     scatter(corr_FAD_ISA(ii),W_MRF_mice_anes_exclude_mean(ii)-W_MRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",[0,0,0],"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% mdl_MRF_W_FAD = fitlm(corr_FAD_ISA,W_MRF_mice_anes_exclude_mean-W_MRF_mice_awake_exclude_mean);
% hold on
...
% annotation('textbox', [p(1), p(2), p(3), p(4)], 'String', equation, 'EdgeColor', 'none', 'Color', 'k');
% 
% title('MRF W vs. FAD Spatial Corr')
% xlabel('FAD Spatial Corr')
% ylabel('MRF W')
% 
% handle = subplot(3,2,5);
% for ii = 1:44
%     if ~isnan(corr_Calcium_ISA(ii))
%     scatter(corr_Calcium_ISA(ii),A_MRF_mice_anes_exclude_mean(ii)-A_MRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",[0,0,0],"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% mdl_MRF_A_Calcium = fitlm(corr_Calcium_ISA,A_MRF_mice_anes_exclude_mean-A_MRF_mice_awake_exclude_mean);
% hold on
...
% annotation('textbox', [p(1), p(2), p(3), p(4)], 'String', equation, 'EdgeColor', 'none', 'Color', 'k');
% 
% title('MRF A vs. Calcium Spatial Corr')
% xlabel('Calcium Spatial Corr')
% ylabel('MRF A')
% 
% handle = subplot(3,2,6);
% for ii = 1:44
%     if ~isnan(corr_FAD_ISA(ii))
%     scatter(corr_FAD_ISA(ii),A_MRF_mice_anes_exclude_mean(ii)-A_MRF_mice_awake_exclude_mean(ii),"MarkerEdgeColor",[0,0,0],"MarkerFaceColor",raw(colorOrder(ii)*scale,:))
%     hold on
%     end
% end
% mdl_MRF_A_FAD = fitlm(corr_FAD_ISA,A_MRF_mice_anes_exclude_mean-A_MRF_mice_awake_exclude_mean);
% hold on
...
% annotation('textbox', [p(1), p(2), p(3), p(4)], 'String', equation, 'EdgeColor', 'none', 'Color', 'k');
% 
% title('MRF A vs. FAD Spatial Corr')
% xlabel('FAD Spatial Corr')
% ylabel('MRF A')

% %% Figure with number of the scatter plot
% figure
% handle = subplot(1,2,1);
% for ii = 1:44
%     if ~isnan(corr_HbT_ISA(ii))
%     text(corr_HbT_ISA(ii),T_HRF_mice_anes_exclude_mean(ii)-T_HRF_mice_awake_exclude_mean(ii),num2str(colorOrder(ii)))
%     hold on
%     end
% end
% mdl_HRF_T_HbT = fitlm(corr_HbT_ISA,T_HRF_mice_anes_exclude_mean-T_HRF_mice_awake_exclude_mean);
...
% for ii = 1:44
%     if ~isnan(corr_HbT_ISA(ii))
%     text(corr_HbT_ISA(ii),A_HRF_mice_anes_exclude_mean(ii)-A_HRF_mice_awake_exclude_mean(ii),num2str(colorOrder(ii)))
%     hold on
%     end
% end
% mdl_HRF_A_HbT = fitlm(corr_HbT_ISA,A_HRF_mice_anes_exclude_mean-A_HRF_mice_awake_exclude_mean);
