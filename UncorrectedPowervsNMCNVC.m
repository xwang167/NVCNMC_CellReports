...
load('E:\RGECO\cat\191030--R5M2285-R5M2286-R5M2288-R6M2460-awake-R6M1-awake-R6M2497-awake-fc.mat',...
     'FAD_ISA_powerMap_mice','FAD_Delta_powerMap_mice', 'jrgeco1a_ISA_powerMap_mice','jrgeco1a_Delta_powerMap_mice')
FAD_ISA_powerMap_mice_awake = FAD_ISA_powerMap_mice;
FAD_Delta_powerMap_mice_awake = FAD_Delta_powerMap_mice;

jrgeco1a_ISA_powerMap_mice_awake = jrgeco1a_ISA_powerMap_mice;
jrgeco1a_Delta_powerMap_mice_awake = jrgeco1a_Delta_powerMap_mice;

load('E:\RGECO\cat\191030--R5M2285-anes-R5M2286-anes-R5M2288-anes-R6M2460-anes-R6M1-anes-R6M2497-anes-fc.mat',...
    'FAD_ISA_powerMap_mice','FAD_Delta_powerMap_mice','jrgeco1a_ISA_powerMap_mice','jrgeco1a_Delta_powerMap_mice')
FAD_ISA_powerMap_mice_anes = FAD_ISA_powerMap_mice;
FAD_Delta_powerMap_mice_anes = FAD_Delta_powerMap_mice;

jrgeco1a_ISA_powerMap_mice_anes = jrgeco1a_ISA_powerMap_mice;
jrgeco1a_Delta_powerMap_mice_anes = jrgeco1a_Delta_powerMap_mice;
...
for excelRow = [181 183 185 228 232 236 202 195 204 230 234 240]
    [~, ~, excelUncorrected]=xlsread(excelFile,1, ['A',num2str(excelRow),':V',num2str(excelRow)]);
    recDate = excelUncorrected{1}; recDate = string(recDate);
    mouseName = excelUncorrected{2}; mouseName = string(mouseName);
    saveDir = excelUncorrected{4}; saveDir = fullfile(string(saveDir),recDate);
    sessionType = excelUncorrected{6}; sessionType = sessionType(3:end-2);
...
clim([0 0.01])
colormap(brewermap(256, '-Spectral'))
sgtitle('Uncorrected ISA Powermaps')
...
title('FAF Anesthetized')
colormap(brewermap(256, '-Spectral'))
sgtitle('Uncorrected Delta Powermaps')
...
legend off
xlabel('r of NVC')
ylabel('Uncorrected ISA Power of Calcium')
...
legend off
xlabel('r of NMC')
ylabel('Uncorrected ISA Power of FAF')
...
annotation('textbox', [p(1), p(2), p(3), p(4)], 'String', equation, 'EdgeColor', 'none', 'Color', 'k');
sgtitle('Uncorrected ISA Power vs. r of NMC/NVC')
...
legend off
xlabel('r of NVC')
ylabel('Uncorrected Delta Power of Calcium')
...
legend off
xlabel('r of NMC')
ylabel('Uncorrected Delta Power of FAF')
...
annotation('textbox', [p(1), p(2), p(3), p(4)], 'String', equation, 'EdgeColor', 'none', 'Color', 'k');
sgtitle('Uncorrected Delta Power vs. r of NMC/NVC')