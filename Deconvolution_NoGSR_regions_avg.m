...
for excelRow = [181 183 185 228 232 236]
    ...
    for n = 1:3
        ...
        load(fullfile(saveDir,'HRF_Regions', strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'HRF_Regions','.mat')))
        load(fullfile(saveDir,'MRF_Regions', strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'MRF_Regions','.mat')))
        % cat r_HRF
