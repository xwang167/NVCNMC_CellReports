...
for excelRow = excelRows
    ...
    for n = runs
        ...
        FCMatrix_Calcium_0p02 = calcFCMatrix(squeeze(xform_jrgeco1aCorr),0.02,0.08,fs,xform_isbrain_mice);
        FCMatrix_Calcium_0p04 = calcFCMatrix(squeeze(xform_jrgeco1aCorr),0.04,0.16,fs,xform_isbrain_mice);
        FCMatrix_Calcium_0p08 = calcFCMatrix(squeeze(xform_jrgeco1aCorr),0.08,0.32,fs,xform_isbrain_mice);
        FCMatrix_Calcium_0p16 = calcFCMatrix(squeeze(xform_jrgeco1aCorr),0.16,0.64,fs,xform_isbrain_mice);
        FCMatrix_Calcium_0p32 = calcFCMatrix(squeeze(xform_jrgeco1aCorr),0.32,1.28,fs,xform_isbrain_mice);
        FCMatrix_Calcium_0p64 = calcFCMatrix(squeeze(xform_jrgeco1aCorr),0.64,2.56,fs,xform_isbrain_mice);
        FCMatrix_Calcium_1p28 = calcFCMatrix(squeeze(xform_jrgeco1aCorr),1.28,5.12,fs,xform_isbrain_mice);
...
for excelRow = excelRows
    ...
    FCMatrix_Calcium_0p02_mouse = [];
    FCMatrix_Calcium_0p04_mouse = [];
    FCMatrix_Calcium_0p08_mouse = [];
    FCMatrix_Calcium_0p16_mouse = [];
    FCMatrix_Calcium_0p32_mouse = [];
    FCMatrix_Calcium_0p64_mouse = [];
    FCMatrix_Calcium_1p28_mouse = [];
    for n = runs
        processedName_fcMatrix = strcat(recDate,'-',mouseName,'-',sessionType,num2str(n),'_fcMatrix','.mat');
        ...
        FCMatrix_Calcium_0p02_mouse = cat(3,FCMatrix_Calcium_0p02_mouse,FCMatrix_Calcium_0p02);
        FCMatrix_Calcium_0p04_mouse = cat(3,FCMatrix_Calcium_0p04_mouse,FCMatrix_Calcium_0p04);
        FCMatrix_Calcium_0p08_mouse = cat(3,FCMatrix_Calcium_0p08_mouse,FCMatrix_Calcium_0p08);
        FCMatrix_Calcium_0p16_mouse = cat(3,FCMatrix_Calcium_0p16_mouse,FCMatrix_Calcium_0p16);
        FCMatrix_Calcium_0p32_mouse = cat(3,FCMatrix_Calcium_0p32_mouse,FCMatrix_Calcium_0p32);
        FCMatrix_Calcium_0p64_mouse = cat(3,FCMatrix_Calcium_0p64_mouse,FCMatrix_Calcium_0p64);
        FCMatrix_Calcium_1p28_mouse = cat(3,FCMatrix_Calcium_1p28_mouse,FCMatrix_Calcium_1p28);
    ...
    FCMatrix_Calcium_0p02_mouse = mean(FCMatrix_Calcium_0p02_mouse,3);
    FCMatrix_Calcium_0p04_mouse = mean(FCMatrix_Calcium_0p04_mouse,3);
    FCMatrix_Calcium_0p08_mouse = mean(FCMatrix_Calcium_0p08_mouse,3);
    FCMatrix_Calcium_0p16_mouse = mean(FCMatrix_Calcium_0p16_mouse,3);
    FCMatrix_Calcium_0p32_mouse = mean(FCMatrix_Calcium_0p32_mouse,3);
    FCMatrix_Calcium_0p64_mouse = mean(FCMatrix_Calcium_0p64_mouse,3);
    FCMatrix_Calcium_1p28_mouse = mean(FCMatrix_Calcium_1p28_mouse,3);
    save(fullfile(saveDir,processedName_fcMatrix_mouse),...
        'FCMatrix_Calcium_ISA_old_mouse','FCMatrix_Calcium_Delta_old_mouse',...
        'FCMatrix_Calcium_0p02_mouse','FCMatrix_Calcium_0p04_mouse',...
        'FCMatrix_Calcium_0p08_mouse','FCMatrix_Calcium_0p16_mouse',...
        'FCMatrix_Calcium_0p32_mouse','FCMatrix_Calcium_0p64_mouse',...
        'FCMatrix_Calcium_1p28_mouse','-append')
end

miceName = [];
FCMatrix_Calcium_ISA_old_mice = [];
FCMatrix_Calcium_Delta_old_mice = [];
FCMatrix_Calcium_0p02_mice = [];
FCMatrix_Calcium_0p04_mice = [];
FCMatrix_Calcium_0p08_mice = [];
FCMatrix_Calcium_0p16_mice = [];
FCMatrix_Calcium_0p32_mice = [];
FCMatrix_Calcium_0p64_mice = [];
...
for excelRow = excelRows
    ...
    FCMatrix_Calcium_0p02_mice = cat(3,FCMatrix_Calcium_0p02_mice,atanh(FCMatrix_Calcium_0p02_mouse));
    FCMatrix_Calcium_0p04_mice = cat(3,FCMatrix_Calcium_0p04_mice,atanh(FCMatrix_Calcium_0p04_mouse));
    FCMatrix_Calcium_0p08_mice = cat(3,FCMatrix_Calcium_0p08_mice,atanh(FCMatrix_Calcium_0p08_mouse));
    FCMatrix_Calcium_0p16_mice = cat(3,FCMatrix_Calcium_0p16_mice,atanh(FCMatrix_Calcium_0p16_mouse));
    FCMatrix_Calcium_0p32_mice = cat(3,FCMatrix_Calcium_0p32_mice,atanh(FCMatrix_Calcium_0p32_mouse));
    FCMatrix_Calcium_0p64_mice = cat(3,FCMatrix_Calcium_0p64_mice,atanh(FCMatrix_Calcium_0p64_mouse));
    FCMatrix_Calcium_1p28_mice = cat(3,FCMatrix_Calcium_1p28_mice,atanh(FCMatrix_Calcium_1p28_mouse));
end
...
FCMatrix_Calcium_0p02_mice = nanmean(FCMatrix_Calcium_0p02_mice,3);
FCMatrix_Calcium_0p04_mice = nanmean(FCMatrix_Calcium_0p04_mice,3);
FCMatrix_Calcium_0p08_mice = nanmean(FCMatrix_Calcium_0p08_mice,3);
FCMatrix_Calcium_0p16_mice = nanmean(FCMatrix_Calcium_0p16_mice,3);
FCMatrix_Calcium_0p32_mice = nanmean(FCMatrix_Calcium_0p32_mice,3);
FCMatrix_Calcium_0p64_mice = nanmean(FCMatrix_Calcium_0p64_mice,3);
FCMatrix_Calcium_1p28_mice = nanmean(FCMatrix_Calcium_1p28_mice,3);

save(fullfile(saveDir_cat,processedName_fcMatrix_mice),...
        'FCMatrix_Calcium_ISA_old_mice','FCMatrix_Calcium_Delta_old_mice',...
        'FCMatrix_Calcium_0p02_mice','FCMatrix_Calcium_0p04_mice',...
        'FCMatrix_Calcium_0p08_mice','FCMatrix_Calcium_0p16_mice',...
        'FCMatrix_Calcium_0p32_mice','FCMatrix_Calcium_0p64_mice',...
        'FCMatrix_Calcium_1p28_mice','-append')
