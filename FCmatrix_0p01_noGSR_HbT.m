...
for excelRow = excelRows
    ...
    for n = runs
        ...
        FCMatrix_HbT_0p01 = calcFCMatrix_noGSR(squeeze(HbT),0.01,0.04,fs,xform_isbrain_mice);
        clear xform_HbTCorr
...
for excelRow = excelRows
    ...
    systemType =excelRaw{5};
    processedName_fcMatrix_mouse = strcat(recDate,'-',mouseName,'-',sessionType,'_fcMatrix_mouse_noGSR','.mat');
    load(fullfile(saveDir,processedName_fcMatrix_mouse),'FCMatrix_HbT_0p01_mouse')
